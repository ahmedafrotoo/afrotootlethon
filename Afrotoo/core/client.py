...
class mainClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
            ...
            async def wrapper(check):
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/soursafrotooby)"
...
mainClient.fast_download_file = download_file
mainClient.fast_upload_file = upload_file
mainClient.reload = restart_script
mainClient.get_msg_link = get_message_link
mainClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    mainClient.send_message = send_message
    mainClient.send_file = send_file
    mainClient.edit_message = edit_message
