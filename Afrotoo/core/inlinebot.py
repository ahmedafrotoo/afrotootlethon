        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" Afrotoo UsᴇʀBoᴛ", "https://t.me/X_X_X_X_R"),
                )
            ]
            ...
            builder = event.builder
            troll = os.path.join("./Afrotoo", "troll.txt")
            try:
            ...
            user, txct = query.split(" ", 1)
            builder = event.builder
            secret = os.path.join("./Afrotoo", "secrets.txt")
            try:
            ...
            query = query[5:]
            builder = event.builder
            hide = os.path.join("./Afrotoo", "hide.txt")
            try:
            ...
            result = builder.article(
                title="© Afrotoo Help",
                description="Afrotoo menu for Afrotoo",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
