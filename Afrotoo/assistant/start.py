...
from Afrotoo import bot
from Afrotoo.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from Afrotoo.sql_helper.botusers_sql import add_me_in_db, his_userid
from Afrotoo.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/lUl_UI"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب عفرتو 🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/lUl_UI")],
            ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("كروب المساعدة ❓", "https://t.me/soursafrotooby")],
            ],
        )
...
async def settings(event):  #    قـسـم  الزغرفـة سيدثون
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء الشـباب
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @soursafrotoo", alert=True)
...
async def settings(event): #    قـسـم  الزغرفـة لأسـماء البـنات
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @soursafrotooby", alert=True)
