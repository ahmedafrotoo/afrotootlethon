...
from .core.session import afrotootlethon
...
LOGS = logging.getLogger("ahmedafrotoo")
bot = l313l
...
if Config.UPSTREAM_REPO == "ahmedafrotoo":
    UPSTREAM_REPO_URL = "https://github.com/ahmedafrotoo/afrotootlethon"
else:
