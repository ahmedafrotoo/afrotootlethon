    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                ...
                buttons=[(Button.url("سورس عفرتو", "https://t.me/soursafrotoo"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    try:
        ...
        if starkbot.bot_inline_placeholder:
            ...
            try:
                ...
                await asyncio.sleep(1)
                await l313l.send_message("@BotFather", sedd)
...
async def add_bot_to_logger_group(chat_id):
    ...
    try:
        ...
        try:
            ...
            LOGS.error(str(e))
#by @soursafrotoo بس اشوفك خامطه للكود اهينك وافضحك
Afrotoo = {"@soursafrotoo", "@soursafrotooby", "@soursafrotoo"}
async def saves():
   for lMl10l in Afrotoo:
        try:
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "- عزيزي المستخدم هذه هي مجموعه الاشعارات يرجى عدم حذفها  - @soursafrotoo"
        photobt = await l313l.upload_file(file="l313l/razan/resources/start/Afthon2.JPEG")
        _, groupid = await create_supergroup(
            "مجموعة أشعارات عفرتو", l313l, Config.TG_BOT_USERNAME, descript, photobt
        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photobt = await l313l.upload_file(file="l313l/razan/resources/start/Afthon.JPEG")
        _, groupid = await create_supergroup(
...
async def install_externalrepo(repo, branch, cfolder):
    ...
    await load_plugins(folder="Afrotoo", extfolder=cfolder)
