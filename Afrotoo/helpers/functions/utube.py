...
PATH = "./SedUb/cache/ytsearch.json"
...
async def yt_search(main):
    try:
        main = urllib.parse.quote(HuRe)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={main}"
        )
...
"""
async def yt_data(main):
    params = {"format": "json", "url": HuRe}
