...
async def _(event):
    ...
    if jok.startswith("@"):
        ...
        Afrotoo = jok.replace("https://t.me/", "@")
    elif str(jok).startswith("-100"):
        Afrotoo = str(jok).replace("-100", "")
    else:
        try:
            Afrotoo = int(jok)
