...
from Afrotoo import StartTime, l313l, JEPVERSION
...
async def amireallyalive(event):
    ...
    me = await l313l.get_me()
     ...
     mention = first_name
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ AFROTOO 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 ✓ ](t.me/soursafrotoo)父**"
    ...
    try:
        ...
        pass
    if HuRe_IMG:
        Afrotoo = [x for x in HuRe_IMG.split()]
