...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular main",
    },
)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular Afrotoo",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna Afrotoo is One of the Popular Afrotoo",
    },
)
async def nekobot(cat):
...
@l313l.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; Afrotoo is One of the Popular Afrotoo",
    },
)
async def nekobot(cat):
