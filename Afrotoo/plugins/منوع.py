...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮اެݪ تِــاެࢪيٰــخَ ¦ Ahmed ](t.me/lUl_UI)   \n"
    "**-** قناة السورس **⪼ [𐇮 AFROTOO ](t.me/soursafrotoo)   "
]
...
async def Hussein(event):
    ...
    await event.edit(f'**ها هيَ الفيزات تم استخراجها من قبل سورس عفرتو** \n@soursafrotoo:\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ المعلومات للفيزا تم استخراجها من قبل سورس عفرتو** \n@soursafrotoo\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ البطاقة تم فحصها من قبل سورس عفرتو** \n@soursafrotoo\n {response.text}')
