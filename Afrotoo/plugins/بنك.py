...
- مثال: .انشاء حساب الرافدين او عفرتو الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def thief(message):
    ...
    await l313l.send_file(
                message.chat_id,
                "https://telegra.ph/file/cf60bb11a3e4e60da049a.jpg",
...
async def bankar(message):
    ...
    if input == "عفرتو الاسلامي":
        bankn = "مصرف عفرتو الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "عفرتو الاسلامي":
